...
bike.Jan19 <- read.csv("/Users/baskar/Documents/ml/Syracuse/IST-719-Info-Viz/Citibike_InfoViz/Jan19-citibike-tripdata.csv", stringsAsFactors = F)
bike.Feb19 <- read.csv("/Users/baskar/Documents/ml/Syracuse/IST-719-Info-Viz/Citibike_InfoViz/Feb19-citibike-tripdata.csv", stringsAsFactors = F)
bike.Mar19 <- read.csv("/Users/baskar/Documents/ml/Syracuse/IST-719-Info-Viz/Citibike_InfoViz/Mar19-citibike-tripdata.csv", stringsAsFactors = F)
bike.Apr19 <- read.csv("/Users/baskar/Documents/ml/Syracuse/IST-719-Info-Viz/Citibike_InfoViz/April19-citibike-tripdata.csv", stringsAsFactors = F)
bike.Dec18 <- read.csv("/Users/baskar/Documents/ml/Syracuse/IST-719-Info-Viz/Citibike_InfoViz/Dec18-citibike-tripdata.csv", stringsAsFactors = F)
bike.Nov18 <- read.csv("/Users/baskar/Documents/ml/Syracuse/IST-719-Info-Viz/Citibike_InfoViz/Nov18-citibike-tripdata.csv", stringsAsFactors = F)
bike.Oct18 <- read.csv("/Users/baskar/Documents/ml/Syracuse/IST-719-Info-Viz/Citibike_InfoViz/Oct18-citibike-tripdata.csv", stringsAsFactors = F)
bike.Sep18 <- read.csv("/Users/baskar/Documents/ml/Syracuse/IST-719-Info-Viz/Citibike_InfoViz/Sep18-citibike-tripdata.csv", stringsAsFactors = F)
bike.Aug18 <- read.csv("/Users/baskar/Documents/ml/Syracuse/IST-719-Info-Viz/Citibike_InfoViz/Aug18-citibike-tripdata.csv", stringsAsFactors = F)
...
bike14.use <- ddply(bike14, c("month", "startime.week", "startime.weekday"), summarise, Use = length(startime.weekday))
